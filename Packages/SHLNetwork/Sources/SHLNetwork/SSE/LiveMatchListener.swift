...
public class LiveMatchListener: ObservableObject {
    public static var shared: LiveMatchListener = .init()

    @Published public var metrics: ConnectionMetrics
    ...
    public func requestInitialData(_ matchIds: [String]) {
