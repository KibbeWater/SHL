...
public actor SSEConnectionManager {
    // MARK: - Constants
    ...
    public func subscribe() -> AsyncStream<LiveGameUpdate> {
        let id = UUID()
    ...
    public func getCachedUpdate(for gameUuid: String) -> LiveGameUpdate? {
        return cache[gameUuid]
    }

    /// Get all cached game updates
    public func getAllCachedUpdates() -> [LiveGameUpdate] {
