...
public final class iCloudSyncManager {
    ...
    public func checkiCloudAvailability() async -> Bool {
        do {
    ...
    public func saveUserSession(userId: String, token: String, expiresAt: Date) async throws {
    ...
    public func fetchUserSession() async throws -> (userId: String, token: String, expiresAt: Date)? {
        let recordID = CKRecord.ID(recordName: userSessionRecordID)
    ...
    public func saveOptInStatus(_ optedIn: Bool) {
    ...
    public func getOptInStatus() -> Bool? {
        let store = NSUbiquitousKeyValueStore.default
    ...
    public func saveNotificationPreferences(_ settings: NotificationSettings) {
        let store = NSUbiquitousKeyValueStore.default
    ...
    public func getNotificationPreferences() -> NotificationSettings? {
        let store = NSUbiquitousKeyValueStore.default
