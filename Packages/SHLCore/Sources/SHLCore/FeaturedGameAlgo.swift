...
public class FeaturedGameAlgo {
    ...
    public static func getFeaturedGame(_ matches: [Match], interestedTeams: [String], favoriteTeamId: String? = nil, liveExternalUUIDs: Set<String> = []) async -> Match? {
    ...
    public static func getTeamByCode(_ code: String) async -> Team? {
