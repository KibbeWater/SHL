...
public func getCodeColor(teamKey: String, callback: @escaping (Color) -> Void) {
...
extension Team {
    public func getTeamColor(callback: @escaping (Color) -> Void) {
...
extension Player {
    public static func fakeData() -> Player {
        return Player(
...
extension Match {
    ...
    public func findVenue(_ cgSize: CGSize, completion: @escaping (Result<(MKMapSnapshotter.Snapshot, CLLocation), Error>) -> Void) {
